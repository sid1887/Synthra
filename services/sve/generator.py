"""
Synthra Vector Engine (SVE) - AI-Powered Component Symbol Generator

This system autonomously generates electronic component symbols when they're not found in the database.
It uses diffusion models (SDXL/Kandinsky) to create images, vectorizes them, normalizes style,
and stores ready-to-use SVG components.

Architecture:
    1. Detection Layer: Checks if component exists in DB
    2. Generation Layer: SDXL Turbo generates schematic-style image
    3. Vectorization Layer: Converts raster → clean SVG
    4. Normalization Layer: CLIP-based style consistency
    5. Storage Layer: PostgreSQL with SVG metadata
    6. Export Layer: React component generation
"""
...
class ComponentSymbolGenerator:
    """
    AI-powered generator for electronic component symbols
    Uses SDXL Turbo for fast, high-quality generation
    """
    ...
    def __init__(
        ...
        # Style guidelines for consistent schematic symbols
        self.base_prompt_suffix = (
